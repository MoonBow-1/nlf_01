...
public final class CLTypeTest {
    ...
    void testIdealCase() {
        ...
        Assertions.assertEquals("97bd8f02-xxxxx.log", actualAppName);
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/cl.json", new EventPartitionContextStub(), new EventPropertiesStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/cl_missing_keys.json", new EventPartitionContextStub(), new EventPropertiesStub(),
                new EventSystemPropertiesStub(), new EnqueuedTimeStub(), new EventOffsetStub()
        );
        ...
        Assertions
                .assertEquals(
                        "{\"RawData\":\"raw data\",\"Computer\":\"computer\",\"_ItemId\":\"123\",\"Type\":\"xx_CL\",\"TenantId\":\"12-xx-34-xx\"}",
                        actualMsg
                );
        Assertions.assertEquals("", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
