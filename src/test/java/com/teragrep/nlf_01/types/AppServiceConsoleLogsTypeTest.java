...
class AppServiceConsoleLogsTypeTest {
    ...
    void testIdealCase() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/appserviceconsolelogs.json", new EventPartitionContextFake(),
                new EventPropertiesFake(), new EventSystemPropertiesFake(), new EnqueuedTimeImpl("2010-01-01T00:00:00"), new EventOffsetImpl("0")
        );

        final AppServiceConsoleLogsType type = new AppServiceConsoleLogsType(parsedEvent, "localhost");
        ...
        Assertions.assertEquals("AppServiceConsoleLogs", actualAppName);
        ...
        Assertions
                .assertEquals(
                        "{\"Category\":\"app-service-console-logs\",\"ContainerId\":\"container-id\",\"Host\":\"host-1\",\"Level\":\"Debug\",\"OperationName\":\"operation-1\",\"ResultDescription\":\"description\",\"SourceSystem\":\"Azure\",\"TenantId\":\"12\",\"TimeGenerated\":\"2020-01-01T01:02:34.5678999Z\",\"Type\":\"AppServiceConsoleLogs\",\"_BilledSize\":1,\"_Internal_WorkspaceResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\",\"_ResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\"}",
                        actualMsg
                );
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/appserviceconsolelogs.json", new EventPartitionContextStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/appserviceconsolelogs_missing_keys.json", new EventPartitionContextStub(),
                new EventPropertiesStub(), new EventSystemPropertiesStub(), new EnqueuedTimeStub(),
                new EventOffsetStub()
        );
        ...
        Assertions
                .assertEquals(
                        "{\"Category\":\"app-service-console-logs\",\"ContainerId\":\"container-id\",\"Host\":\"host-1\",\"Level\":\"Debug\",\"OperationName\":\"operation-1\",\"ResultDescription\":\"description\",\"SourceSystem\":\"Azure\",\"TenantId\":\"12\",\"_BilledSize\":1}",
                        actualMsg
                );
        Assertions.assertEquals("", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
