...
final class StorageFileTypeTest {
    ...
    void testIdealCase() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/storagefilelogs.json", new EventPartitionContextFake(), new EventPropertiesFake(),
        ...
        Assertions.assertEquals("StorageFileLogs", actualAppName);
        Assertions.assertEquals(Facility.AUDIT, actualFacility);
        Assertions.assertEquals("md5-af709d6b4e17c20d133f45a56a04592d-storageaccount1", actualHostname);
        Assertions
                .assertEquals(
                        "{\"AccountName\":\"storageaccount1\",\"AuthenticationHash\":\"hash123456789\",\"AuthenticationType\":\"token\",\"AuthorizationDetails\":{},\"CallerIpAddress\":\"127.0.0.1\",\"Category\":\"category1\",\"ClientRequestId\":\"123\",\"ConditionsUsed\":\"condition1=true;\",\"ContentLengthHeader\":234,\"CorrelationId\":\"345\",\"DurationMs\":12,\"Etag\":\"123-a\",\"LastModifiedTime\":\"2010-10-01T11:59:26.256Z\",\"Location\":\"countrycentral\",\"MetricResponseType\":\"type1\",\"ObjectKey\":\"123456789abc\",\"OperationCount\":2,\"OperationName\":\"copy\",\"OperationVersion\":\"1.0.0\",\"Protocol\":\"http\",\"ReferrerHeader\":\"referer1\",\"RequestBodySize\":23,\"RequesterAppId\":\"abc123456789\",\"RequesterAudience\":\"audience1\",\"RequesterObjectId\":\"12345678-1234-1234-abcd-1234567890ab\",\"RequesterTenantId\":\"12345678-1234-1234-abcd-1234567890abc\",\"RequesterTokenIssuer\":\"issuer1\",\"RequesterUpn\":\"example1@example.localhost\",\"RequesterUserName\":\"example1\",\"RequestHeaderSize\":34,\"RequestMd5\":\"12345678901234567890123456789012\",\"ResponseBodySize\":45,\"ResponseHeaderSize\":56,\"ResponseMd5\":\"12345678901234567890123456789013\",\"SasExpiryStatus\":\"status1\",\"SchemaVersion\":\"1.1.1\",\"ServerLatencyMs\":1.5,\"ServiceType\":\"service1\",\"SmbCommandDetail\":\"0x2000 bytes at offset 0xf2000\",\"SmbCommandMajor\":\"0x6\",\"SmbCommandMinor\":\"DirectoryCloseAndDelete\",\"SmbCreditsConsumed\":\"0x3\",\"SmbFileId\":\"0x9223442405598953\",\"SmbMessageID\":\"0x3b165\",\"SmbPersistentHandleID\":\"0x6003f\",\"SmbPrimarySID\":\"S-1-5-21-1111111111-2222222222-33333333-4444\",\"SmbSessionID\":\"0x8530280128000049\",\"SmbStatusCode\":\"206\",\"SmbTreeConnectID\":\"0x3\",\"SmbVolatileHandleID\":\"0xFFFFFFFF00000065\",\"SourceSystem\":\"Azure\",\"StatusCode\":\"200\",\"StatusText\":\"success\",\"TenantId\":\"12345678-1234-1234-abcd-1234567890ab\",\"TimeGenerated\":\"2020-10-01T11:59:26.256Z\",\"TlsVersion\":\"1.3\",\"Type\":\"StorageFileLogs\",\"Uri\":\"https://example.localhost\",\"UserAgentHeader\":\"User-Agent: product/1.0\",\"_ResourceId\":\"/SUBSCRIPTIONS/uuid/RESOURCEGROUPS/ab-cd-efgh-ijklmn-xx-DEV-01/PROVIDERS/postgres-db/FLEXIBLESERVERS/efgh-ijklmn-xx-DEV-01\"}",
                        actualMsg
                );
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/storagefilelogs.json", new EventPartitionContextStub(), new EventPropertiesStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/storagefilelogs_missing_keys.json", new EventPartitionContextStub(),
        ...
        Assertions
                .assertEquals(
                        "{\"AuthenticationHash\":\"hash123456789\",\"AuthenticationType\":\"token\",\"AuthorizationDetails\":{},\"CallerIpAddress\":\"127.0.0.1\",\"Category\":\"category1\",\"ClientRequestId\":\"123\",\"ConditionsUsed\":\"condition1=true;\",\"ContentLengthHeader\":234,\"CorrelationId\":\"345\",\"DurationMs\":12,\"Etag\":\"123-a\",\"LastModifiedTime\":\"2010-10-01T11:59:26.256Z\",\"Location\":\"countrycentral\",\"MetricResponseType\":\"type1\",\"ObjectKey\":\"123456789abc\",\"OperationCount\":2,\"OperationName\":\"copy\",\"OperationVersion\":\"1.0.0\",\"Protocol\":\"http\",\"ReferrerHeader\":\"referer1\",\"RequestBodySize\":23,\"RequesterAppId\":\"abc123456789\",\"RequesterAudience\":\"audience1\",\"RequesterObjectId\":\"12345678-1234-1234-abcd-1234567890ab\",\"RequesterTenantId\":\"12345678-1234-1234-abcd-1234567890abc\",\"RequesterTokenIssuer\":\"issuer1\",\"RequesterUpn\":\"example1@example.localhost\",\"RequesterUserName\":\"example1\",\"RequestHeaderSize\":34,\"RequestMd5\":\"12345678901234567890123456789012\",\"ResponseBodySize\":45,\"ResponseHeaderSize\":56,\"ResponseMd5\":\"12345678901234567890123456789013\",\"SasExpiryStatus\":\"status1\",\"SchemaVersion\":\"1.1.1\",\"ServerLatencyMs\":1.5,\"ServiceType\":\"service1\",\"SmbCommandDetail\":\"0x2000 bytes at offset 0xf2000\",\"SmbCommandMajor\":\"0x6\",\"SmbCommandMinor\":\"DirectoryCloseAndDelete\",\"SmbCreditsConsumed\":\"0x3\",\"SmbFileId\":\"0x9223442405598953\",\"SmbMessageID\":\"0x3b165\",\"SmbPersistentHandleID\":\"0x6003f\",\"SmbPrimarySID\":\"S-1-5-21-1111111111-2222222222-33333333-4444\",\"SmbSessionID\":\"0x8530280128000049\",\"SmbStatusCode\":\"206\",\"SmbTreeConnectID\":\"0x3\",\"SmbVolatileHandleID\":\"0xFFFFFFFF00000065\",\"SourceSystem\":\"Azure\",\"StatusCode\":\"200\",\"StatusText\":\"success\",\"TenantId\":\"12345678-1234-1234-abcd-1234567890ab\",\"TlsVersion\":\"1.3\",\"Uri\":\"https://example.localhost\",\"UserAgentHeader\":\"User-Agent: product/1.0\",\"_ResourceId\":\"/SUBSCRIPTIONS/uuid/RESOURCEGROUPS/ab-cd-efgh-ijklmn-xx-DEV-01/PROVIDERS/postgres-db/FLEXIBLESERVERS/efgh-ijklmn-xx-DEV-01\"}",
                        actualMsg
                );
        Assertions.assertEquals("", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
