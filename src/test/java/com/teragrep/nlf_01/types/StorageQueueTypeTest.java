...
final class StorageQueueTypeTest {
    ...
    void testIdealCase() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/storagequeuelogs.json", new EventPartitionContextFake(), new EventPropertiesFake(),
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/storagequeuelogs.json", new EventPartitionContextStub(), new EventPropertiesStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/storagequeuelogs_missing_keys.json", new EventPartitionContextStub(),
