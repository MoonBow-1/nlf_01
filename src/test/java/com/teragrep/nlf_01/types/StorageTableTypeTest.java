...
final class StorageTableTypeTest {
    ...
    void testIdealCase() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/storagetablelogs.json", new EventPartitionContextFake(), new EventPropertiesFake(),
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/storagetablelogs.json", new EventPartitionContextStub(), new EventPropertiesStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/storagetablelogs_missing_keys.json", new EventPartitionContextStub(),
